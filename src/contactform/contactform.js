...
<form>
<input className="name mr10" name="name" type="text"  placeholder="Name"/>
<input className="email ml10" name="email" type="text"  placeholder="Email"/><br/>
<input className="subject" name="subject"  type="text" placeholder="Subject"/><br/>
